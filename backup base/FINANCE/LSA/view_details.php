    ...
    try {
        // Fetch client and application info gamit ang PDO
        ...
        // Fetch documents gamit ang PDO
        $docQuery = "SELECT * FROM loan_documents WHERE loan_application_id = :id";
        $docStmt = $pdo->prepare($docQuery);
        $docStmt->execute(['id' => $application_id]);
    ...
    <body>
        ...
        <div class="main-content">
            <div class="page-header">
                ...
                <h1 style="font-size: 24px; color: #fff;">Application Review: #LA-<?php echo htmlspecialchars($app['id']); ?></h1>
            </div>
            ...
            <div class="details-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                ...
                <div class="info-card" style="background: #1f2937; border: 1px solid #374151; border-radius: 12px; padding: 20px;">
                    ...
                    <div class="data-row" style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                        ...
                        <span class="badge-red" style="color: #ef4444; background: rgba(239, 68, 68, 0.1); padding: 2px 10px; border-radius: 20px; font-size: 11px;"><?php echo htmlspecialchars($app['status']); ?></span>
                    </div>
            ...
            <?php if (!empty($documents)): ?>
                ...
                <div class="doc-preview-card" style="background: #111827; border: 1px solid #374151; border-radius: 10px; overflow: hidden; display: flex; flex-direction: column; transition: transform 0.2s;">
                    <div style="padding: 10px 15px; border-bottom: 1px solid #374151; display: flex; justify-content: space-between; align-items: center; background: #1f2937;">
                        <span style="color: #fff; font-size: 13px; font-weight: 600;"><?php echo htmlspecialchars($label); ?></span>
                        <a href="<?php echo htmlspecialchars($filePath); ?>" target="_blank" style="color: #34d399; font-size: 16px;"><i class="bi bi-box-arrow-up-right"></i></a>
                    </div>
                    ...
                    <div style="width: 100%; height: 220px; background: #000; display: flex; align-items: center; justify-content: center; overflow: hidden; padding: 5px;">
                        ...
                        if(in_array(strtolower($ext), ['jpg', 'jpeg', 'png', 'webp'])): ?>
                            <img src="<?php echo htmlspecialchars($filePath); ?>" alt="<?php echo htmlspecialchars($label); ?>" 
