...
// Check kung pumasok ang PDO connection
if (!isset($pdo)) { die("Fatal Error: \$pdo variable is not defined."); }

/** * FETCH PENDING APPLICATIONS */
try {
    $stmt = $pdo->query("
        SELECT la.id, la.principal_amount, la.status, u.fullname 
                ...
                <tbody id="applicationTable">
                    <?php if (!empty($applications)): ?>
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-orange"><?php echo htmlspecialchars($row['status']); ?></span></td>
