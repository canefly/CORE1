...
try {
    ...
    // Naka-save ang data dito sa $forwarded_apps array
    $forwarded_apps = $stmt->fetchAll(PDO::FETCH_ASSOC);
        ...
        <div class="content-card">
            <table>
                ...
                <tbody id="forwardedTable">
                    <?php if (!empty($forwarded_apps)): ?>
                        <?php foreach($forwarded_apps as $row): ?>
                        <tr>
                            <td style="color:#a78bfa; font-weight:700;">#LA-<?php echo htmlspecialchars($row['id']); ?></td>
                            <td>
