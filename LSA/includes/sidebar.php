...
// Initial Page Load Queries (Sync sa bagong backend logic)
    ...
    <ul class="nav-links">
        ...
        <li>
            <a href="application.php" class="nav-item <?= ($currentPage == 'application.php') ? 'active' : '' ?>">
                ...
                <span class="nav-badge" style="<?= $newAppCount > 0 ? '' : 'display:none;' ?>"><?= $newAppCount ?></span>
            </a>
        </li>
        ...
        <li>
            <a href="restructure.php" class="nav-item <?= ($currentPage == 'restructure.php') ? 'active' : '' ?>">
                ...
                <span class="nav-badge amber" style="<?= $restructureCount > 0 ? '' : 'display:none;' ?>"><?= $restructureCount ?></span>
            </a>
        </li>
    </ul>
